    ...
    <div class="jtk-demo">
        <div class="jtk-demo-canvas canvas-wide drag-drop-demo jtk-surface jtk-surface-nopan" id="canvas">
            ...
            <div class="window" id="dragDropWindow4">four<br /><br />
                ...
                <a href="#" class="cmdLink detach" rel="dragDropWindow4">detach all</a>
            </div>
            <div id="list"></div>
        </div>
    </div>
        ...
        var listDiv = document.getElementById("list"),
            ...
            updateConnections = function (conn, remove) {
                ...
                if (connections.length > 0) {
                    var s =
                        "<span><strong>Connections</strong></span><br/><br/><table><tr><th>Scope</th><th>Source</th><th>Target</th></tr>";
        ...
        jsPlumb.ready(function () {
            ...
            instance.batch(function () {
                ...
                var e4 = instance.addEndpoint(
                    "dragDropWindow4",//元素的id
                    { anchor: [1, 0.5, 1, 0] },//锚点位置
                    exampleEndpoint
                );
